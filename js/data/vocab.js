...
export const VOCAB = [
  ...
  // --- l61: Everyday Action Verbs I — growing the general verb pool
  // (Conjugation Cycle drew from only 44 infinitives total; this is a
  // first, quality-checked batch toward a much larger target, not the
  // whole thing at once). ---
  v('v_dzvonyty', 'дзвонити', 'dzvonyty', 'to call / to ring', 'volat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_slukhaty', 'слухати', 'slukhaty', 'to listen', 'poslouchat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_dyakuvaty', 'дякувати', 'dyakuvaty', 'to thank', 'děkovat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_spivaty', 'співати', 'spivaty', 'to sing', 'zpívat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_tantsyuvaty', 'танцювати', 'tantsyuvaty', 'to dance', 'tančit', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_malyuvaty', 'малювати', 'malyuvaty', 'to draw / to paint', 'kreslit', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_hotuvaty', 'готувати', 'hotuvaty', 'to cook / to prepare', 'vařit', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_myty', 'мити', 'myty', 'to wash (something)', 'mýt', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_praty', 'прати', 'praty', 'to launder / to wash clothes', 'prát', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_prybyraty', 'прибирати', 'prybyraty', 'to clean / to tidy up', 'uklízet', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_vidkryvaty', 'відкривати', 'vidkryvaty', 'to open', 'otevírat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_zakryvaty', 'закривати', 'zakryvaty', 'to close', 'zavírat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_vmykaty', 'вмикати', 'vmykaty', 'to turn on', 'zapínat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_vymykaty', 'вимикати', 'vymykaty', 'to turn off', 'vypínat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_prynosyty', 'приносити', 'prynosyty', 'to bring', 'přinášet', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_vidnosyty', 'відносити', 'vidnosyty', 'to take away / to carry off', 'odnášet', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_nosyty', 'носити', 'nosyty', 'to carry / to wear', 'nosit', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_shukaty', 'шукати', 'shukaty', 'to search / to look for', 'hledat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_znakhodyty', 'знаходити', 'znakhodyty', 'to find', 'nacházet', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_hubyty', 'губити', 'hubyty', 'to lose', 'ztrácet', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_zalyshaty', 'залишати', 'zalyshaty', 'to leave (something behind)', 'nechávat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_kydaty', 'кидати', 'kydaty', 'to throw', 'házet', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_lovyty', 'ловити', 'lovyty', 'to catch', 'chytat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_buduvaty', 'будувати', 'buduvaty', 'to build', 'stavět', 'verb', { aspect: 'imperfective', topics: ['l61'] }),
  v('v_rozmovlyaty', 'розмовляти', 'rozmovlyaty', 'to converse / to chat', 'rozmlouvat', 'verb', { aspect: 'imperfective', topics: ['l61'] }),

  // --- l62: Everyday Action Verbs II ---
  v('v_plakaty', 'плакати', 'plakaty', 'to cry', 'plakat', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_smiyatysya', 'сміятися', 'smiyatysya', 'to laugh', 'smát se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_krychaty', 'кричати', 'krychaty', 'to shout', 'křičet', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_movchaty', 'мовчати', 'movchaty', 'to be silent', 'mlčet', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_spaty', 'спати', 'spaty', 'to sleep', 'spát', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_prokydatysya', 'прокидатися', 'prokydatysya', 'to wake up', 'probouzet se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_lyahaty', 'лягати', 'lyahaty', 'to lie down', 'lehat si', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_vstavaty', 'вставати', 'vstavaty', 'to get up / to stand up', 'vstávat', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_sydity', 'сидіти', 'sydity', 'to sit', 'sedět', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_stoyaty', 'стояти', 'stoyaty', 'to stand', 'stát', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_lezhaty', 'лежати', 'lezhaty', 'to lie (be in a lying position)', 'ležet', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_bihty', 'бігти', 'bihty', 'to run', 'běžet', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_strybaty', 'стрибати', 'strybaty', 'to jump', 'skákat', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_padaty', 'падати', 'padaty', 'to fall', 'padat', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_rukhatysya', 'рухатися', 'rukhatysya', 'to move', 'hýbat se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_zupynyatysya', 'зупинятися', 'zupynyatysya', 'to stop (oneself)', 'zastavovat se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_povertatysya', 'повертатися', 'povertatysya', 'to return', 'vracet se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_vykhodyty', 'виходити', 'vykhodyty', 'to exit / to go out', 'vycházet', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_zakhodyty', 'заходити', 'zakhodyty', 'to enter / to come in', 'vcházet', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_hotuvatysya', 'готуватися', 'hotuvatysya', 'to prepare oneself / to get ready', 'připravovat se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_odyahatysya', 'одягатися', 'odyahatysya', 'to get dressed', 'oblékat se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
  v('v_rozdyahatysya', 'роздягатися', 'rozdyahatysya', 'to undress', 'svlékat se', 'verb', { aspect: 'imperfective', topics: ['l62'] }),
